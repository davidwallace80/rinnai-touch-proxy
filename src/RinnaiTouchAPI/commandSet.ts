...
export const serviceCommandSet = serviceId => {
  return {
    ...
    coolingCalled: {
      path: `${serviceId}.SAD.CL`,
      values: {Y: true, N: false},
      readWrite: false,
      description: 'Calling for cooling',
      supportedServices: ['reverseCycle'],
    },
    heatingCalled: {
      path: `${serviceId}.SAD.HT`,
      values: {Y: true, N: false},
      readWrite: false,
      description: 'Calling for heating',
      supportedServices: ['reverseCycle'],
    },
    compressorState: {
      path: `${serviceId}.SAD.CP`,
      values: {F: 'off', N: 'on'},
      readWrite: false,
    ...
    circulationFan: {
      ...
      supportedServices: ['gasHeating', 'addonCooling'],
    },
    fanState: {
      path: `${serviceId}.SAD.IF`,
      values: {F: 'off', N: 'on'},
      readWrite: false,
